...
export default function LoginButton() {
    ...
    return (
        <button
            ...
            className="flex items-center gap-2 bg-white border border-slate-200 rounded-lg px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 shadow-sm"
        >
